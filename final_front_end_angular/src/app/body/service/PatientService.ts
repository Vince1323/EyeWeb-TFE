...
export class PatientService {
    ...
    /**
     * Récupère les patients filtrés et paginés.
     * @param organizationsId Liste des ID d'organisations
    ...
    const url = `${this.API_URL}${this.ENDPOINT_PATIENTS}/organizations/${organizationsId.join(',')}/filter`;
    return this.httpClient.get<any>(`${url}?search=${search}&page=${page}&size=${size}`);
    }
