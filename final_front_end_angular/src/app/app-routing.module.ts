...
const routes: Routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: () =>
                  import('./body/components/exam/exam.module').then(m => m.ExamModule),
                canActivate: [AuthGuard],
              ...
              },
              {
                ...
                loadChildren: () =>
                  import('./body/components/consultation/consultation.module').then(m => m.ConsultationModule),
                canActivate: [AuthGuard],
            ...
            {
                path: 'cataract/patients/:id/planning',
                loadChildren: () =>
                  import('./body/components/cataract/planning/planning.module').then(m => m.PlanningModule)
              },
              {
                path: 'cataract/patients/:id/protocol',
                loadChildren: () =>
                  import('./body/components/cataract/protocol/protocol.module').then(m => m.ProtocolModule)
              },
              {
                path: 'cataract/patients/:id/postoperative',
                loadChildren: () =>
                  import('./body/components/cataract/postoperative/postoperative.module').then(m => m.PostoperativeModule)
              },     
              {
                path: 'patients/:idPatient/refractive',
                loadChildren: () =>
                  import('./body/components/refractive/refractive.module').then(m => m.RefractiveModule),
                canActivate: [AuthGuard],
                data: { breadcrumb: 'Refractive' }
              },
              {
                path: 'patients/:idPatient/glaucoma',
                loadChildren: () =>
                  import('./body/components/glaucoma/glaucoma.module').then(m => m.GlaucomaModule),
                canActivate: [AuthGuard],
                data: { breadcrumb: 'Glaucoma' }
              },   
        ],
    },
    {
