...
public class PatientServiceImpl implements PatientService {
    ...
    @Override
    public Page<Patient> getFilteredPatients(List<Long> organizationsId, String search, int page, int size) {
        Pageable pageable = (Pageable) PageRequest.of(page, size);
        return patientRepository.findFilteredPatientsByOrganizationsId(organizationsId, search, pageable);
    }
